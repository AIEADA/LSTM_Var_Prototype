...
def plot_contours(field,crange_max,title='Figure'):
...
def plot_averaged_errors(true_fields, pred_fields, snapshots_mean):
    ...
    plot_contours(mae_fields,130,'Mean absolute error')
    plot_contours(rmse_fields,130,'Root Mean squared error')
    ...
    plot_contours(r_plot,1,'Pearson R plot')
    plot_contours(cos_plot,1,'Cosine similarity plot')

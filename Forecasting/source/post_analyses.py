...
def perform_analyses(data_paths,var_time,cadence,num_ips,num_ops,num_modes,test_fields,forecast,save_path,subregions):
    ...
    if var_time+num_ips+num_ops > yearly_snaps:
        ...
        climatology = climatology[:,:,:var_time+num_ips+num_ops]        
    ...
    for lead_time in range(num_ops):
        ...
        clim_fields = climatology[:,:,num_ips+lead_time:num_ips+lead_time+var_time]
